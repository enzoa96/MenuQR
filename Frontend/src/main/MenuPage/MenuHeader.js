...
import Header, { NavLink, NavLinks, defaultLinks, PrimaryLink, LogoLink, NavToggle, DesktopNavLinks } from "../components/THeader.js";
...
const HeroContainer = tw.div`z-20 relative px-4 sm:px-8 max-w-screen-xl mx-auto text-center`;
const TwoColumn = tw.div`pt-24 pb-32 px-4 flex justify-between items-center flex-col lg:flex-row`;
const LeftColumn = tw.div`flex flex-col items-center lg:block`;
const RightColumn = tw.div`w-full sm:w-5/6 lg:w-1/2 mt-16 lg:mt-0 lg:pl-8`;

const Heading = styled.h1`
  ${tw`text-3xl text-center lg:text-center pt-16 pb-20 sm:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-100 leading-none`}
  span {
    ...
    <Container>
      ...
      <HeroContainer>
            <Heading>
              ...
              <br />
              <SlantedBackground>Los Chinardos</SlantedBackground>
            </Heading>
      </HeroContainer>
    </Container>
  );
